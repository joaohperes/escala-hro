            ...
            ramaisList.innerHTML = departamentos.map(dept => {
                ...
                return `
                    <div class="ramal-item" data-search="${dept.name.toLowerCase()} ${extsStr}">
                        ...
                        <div class="ramal-separator">|</div>
                        <div class="ramal-exts-inline">
                            <span class="ramal-exts-inline-value">${extsStr}</span>
                        </div>
                    </div>
                `;
            }).join('');

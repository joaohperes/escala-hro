                                    ...
                                    <div class="turno-coluna" data-turno-tipo="${tipoBadge}">
                                        ...
                                        <div class="profissionais-list">
                                            ${profs.map(prof => {
                                                ...
                                                return `
                                                <div class="profissional" data-prof="${prof.profissional}" data-setor="${setor}" data-turno="${turno}" data-tipo="${prof.tipo_turno}" data-hora="${prof.horario}" data-search="${prof.profissional.toLowerCase()} ${setor.toLowerCase()} ${turno.toLowerCase()} ${prof.tipo_turno.toLowerCase()} ${prof.horario.toLowerCase()}">
                        ...
                        <div class="categoria-content">
                            <div class="profissionais-list">
                                ${profissionais.map(prof => {
                                    ...
                                    const whatsappUrl = `https://wa.me/55${telefoneLimpo}`;
                                    return `
                                    <div class="profissional" data-prof="${prof.profissional}" data-setor="${setor}" data-turno="${prof.tipo_turno}" data-tipo="${prof.tipo_turno}" data-hora="${prof.horario}" data-search="${prof.profissional.toLowerCase()} ${setor.toLowerCase()} ${prof.tipo_turno.toLowerCase()} ${prof.horario.toLowerCase()}">
                                        <div class="profissional-nome">
                                            ${telefone !== 'N/A' ? `<a href="${whatsappUrl}" target="_blank" class="telefone-tooltip" title="Clique para enviar WhatsApp"><span class="telefone-icon"></span>${telefone}</a>` : ''}
                                            <div class="profissional-nome-wrapper">
                                                <span class="profissional-nome-text">${prof.profissional}</span>
